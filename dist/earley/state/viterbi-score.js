(function (dependencies, factory) {
    ...
    function setViterbiScores(stateSets, completedState, originPathTo, m) {
        ...
        var completedViterbi = stateSets.viterbiScores
            .get(completedState)
            .innerScore;
        ...
        stateSets.getStatesActiveOnNonTerminal(Y, completedState.ruleStartPosition, pos).forEach(function (stateToAdvance) {
            ...
            var resultingState = stateSets.states.getState(rule, pos, ruleStart, nextDot);
            if (!resultingState) {
            ...
            var viterbiScore = stateSets.viterbiScores.get(resultingState);
            var prevViterbi = stateSets.viterbiScores.get(stateToAdvance);
